...
//	}
    ...
    public static String formatPhoneWithStar(String phone) {
        if (ToolUtil.isEmpty(phone) || !PhoneUtil.isPhoneSimple(phone)) {
            return phone;
        }
     ...
     * @param s
     */
    private static void checkContent(String content, String s,int count) {
        count++;
    ...
    public static void main(String[] args) {
        String data = "【摩氏黑咖啡】夏日不敢秀腰？没事！每天喝一杯摩氏黑咖，小跑1公里，助你快速瘦腰！ 复制链接进淘－宝买来试试吧！https://m.tb.cn/h.eRpRMLR?sm=c1eb05退订回T";
