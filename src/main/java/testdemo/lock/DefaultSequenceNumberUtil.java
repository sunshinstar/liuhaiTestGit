...
public class DefaultSequenceNumberUtil {
    ...
    public static long getMsgIdSequenceNo() {
        return msgIdSequenceId.getAndIncrement();
    }
    ...
    private final static AtomicInteger msgIdSequenceId = new AtomicInteger(Math.abs(RandomUtils.nextInt()));
}
