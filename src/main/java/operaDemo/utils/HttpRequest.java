...
public class HttpRequest {
    ...
    private static List<Object> arrayToList(Object array) {
        if (array instanceof Object[]) {
            ...
            if (array instanceof int[]) {
                ...
                boolean[] var7 = (boolean[])((boolean[])array);
                var3 = var7.length;

                for(var4 = 0; var4 < var3; ++var4) {
                    boolean value = var7[var4];
                    result.add(value);
                }
            } else if (array instanceof long[]) {
                long[] var8 = (long[])((long[])array);
                var3 = var8.length;

                for(var4 = 0; var4 < var3; ++var4) {
                    long value = var8[var4];
                    result.add(value);
                }
                ...
                for(var4 = 0; var4 < var3; ++var4) {
                    double value = var10[var4];
                    result.add(value);
                }
            } else if (array instanceof short[]) {
                short[] var11 = (short[])((short[])array);
                var3 = var11.length;

                for(var4 = 0; var4 < var3; ++var4) {
                    short value = var11[var4];
                    result.add(value);
                }
            } else if (array instanceof byte[]) {
                byte[] var12 = (byte[])((byte[])array);
                var3 = var12.length;

                for(var4 = 0; var4 < var3; ++var4) {
                    byte value = var12[var4];
                    result.add(value);
                }
            } else if (array instanceof char[]) {
                char[] var13 = (char[])((char[])array);
                var3 = var13.length;

                for(var4 = 0; var4 < var3; ++var4) {
                    char value = var13[var4];
                    result.add(value);
                }
            }
    ...
    public static String encode(CharSequence url) throws HttpRequestException {
        ...
        try {
            ...
            throw new HttpRequestException(var7);
        }
    ...
    public HttpRequest(CharSequence url, String method) throws HttpRequestException {
        ...
        try {
            ...
            throw new HttpRequestException(var4);
        }
    ...
    private HttpURLConnection createConnection() {
        try {
            ...
            throw new HttpRequestException(var2);
        }
    }
    ...
    public byte[] bytes() throws HttpRequestException {
        ...
        try {
            ...
            throw new HttpRequestException(var3);
        }
            ...
            if (stream == null) {
                try {
                    ...
                    if (this.contentLength() > 0) {
                        throw new HttpRequestException(var5);
                    }
    ...
    public HttpRequest part(String name, String filename, String contentType, String part) throws HttpRequestException {
        try {
            ...
            throw new HttpRequestException(var6);
        }
    }
    ...
    protected abstract static class Operation<V> implements Callable<V> {
        ...
        public V call() throws HttpRequestException {
            ...
            try {
                var2 = this.run();
            } catch (HttpRequestException var11) {
                thrown = true;
                throw var11;
            } catch (IOException var12) {
                thrown = true;
                throw new HttpRequestException(var12);
            } finally {
                try {
                    this.done();
                } catch (IOException var13) {
                    if (!thrown) {
                        throw new HttpRequestException(var13);
                    }
                }
