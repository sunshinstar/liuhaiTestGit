...
public class VedioSms {
    ...
    public static String GetParams() throws Exception {
        ...
        Long requestTime = (long) 2019032518;
        Long sentTime = null;
        Long tempId = (long) 200226;

        Submit submit = new Submit();
        //接口账号       @
        submit.setAppKey("2ab64");
        //请求时间Long  @
        ...
        stringBuffer.append("cc747699295eb5a4");
